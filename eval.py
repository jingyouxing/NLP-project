...
def calculate_score_S(json_file_path, csv_file_path, response_column='response', use_english=True):
    """
...
if __name__ == "__main__":
    ...
    try:
        ...
        overall_score, detailed_results = calculate_score_S(
            ...
            response_column='response',  # Change this if your column has a different name
